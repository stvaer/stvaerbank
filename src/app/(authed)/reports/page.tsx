      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground">
            Here's a summary of your cash flow for the last 6 months.
          </p>
        </div>
        <Button className="border-primary text-primary" variant="outline">Generate Report</Button>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Summary of income vs expenses</p>
          </CardContent>
        </Card>
      </div>
